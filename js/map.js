...
function generateCard(item) {
  ...
  for (var i = 0; i < item.offer.features.length; i++) {
    ...
    if(item.offer.features[i] === "wifi") {
      feature.className = "popup__feature popup__feature--wifi"
    } else if (item.offer.features[i] === "dishwasher") {
      feature.className = "popup__feature popup__feature--dishwasher"
    } else if (item.offer.features[i] === "parking") {
      feature.className = "popup__feature popup__feature--parking"
    } else if (item.offer.features[i] === "washer") {
      feature.className = "popup__feature popup__feature--washer"
    } else if (item.offer.features[i] === "elevator") {
      feature.className = "popup__feature popup__feature--elevator"
    } else if (item.offer.features[i] === "conditioner") {
      feature.className = "popup__feature popup__feature--conditioner"
    }
